...
const ProductPamphletFull = (product: product) => {
  ...
  return (
    <div className=" w-11/12 md:w-8/12 bg-blue-200 h-[200px] flex items-center px-2 md:px-7 rounded-xl group hover:shadow-xl transition-all duration-500">
      <a href={'/product/' + product.id} className="h-1/2 w-1/3 md:w-1/5 md:h-full flex items-center md:group-hover:w-2/6 transition-all duration-500 rounded-xl">
